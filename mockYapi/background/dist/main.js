...
/*!*****************************!*\
  !*** ./background/const.js ***!
  \*****************************/
/*! exports provided: dicOfString */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dicOfString", function() { return dicOfString; });
const dicOfString = [{
  label: '@date',
  value: '@date'
}, {
...
const PICK_PICTURES = ['https://osstestnew.zdcustom.com/media/product_image/private/2024/10/06/317/2e4f201788ea4a80b79b170714917c33_t.jpeg', 'https://osstestnew.zdcustom.com/media/product_image/private/2024/09/30/317/b0e53d4339ca457e9bfcbf6c37303a8e_t.jpg', 'https://osstestnew.zdcustom.com/media/product_image/private/2024/09/30/648/61e3a714abbb4bab8522e5a929b346cc_t.png', 'https://osstestnew.zdcustom.com/media/product_image/private/2024/09/30/648/1dffd8458b884cfe86b608179a8440fb_t.jpg', 'https://osstestnew.zdcustom.com/media/product_image/private/2024/09/30/648/aac634af835d43c4b34b030fc0cc7e16_t.jpg', 'https://osstestnew.zdcustom.com/media/product_image/private/2024/09/30/344/a499ad2073cf48f492878dd409fe5843_t.png', 'https://osstestnew.zdcustom.com/media/product_image/private/2024/09/30/492/f6a90b2826ab4792a3b9ed22ea54d61c_t.jpg', 'https://osstestnew.zdcustom.com/media/product_image/private/2024/09/30/820/94a16a59a55f4802bda1738578f0c871_t.jpg', 'https://osstestnew.zdcustom.com/media/product_image/private/2024/09/30/344/94d6f8983f1048359b56ecff8a83dd6a_t.jpg', 'https://osstestnew.zdcustom.com/media/product_image/private/2024/09/29/492/a75e87d651e44c919aeb8740b33118b4_t.jpg'];
mockjs__WEBPACK_IMPORTED_MODULE_0___default.a.Random.extend({
  ossImage() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mockClass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mockClass */ "./background/mockClass.js");
/* harmony import */ var zod_v4__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! zod/v4 */ "zod/v4");
/* harmony import */ var zod_v4__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(zod_v4__WEBPACK_IMPORTED_MODULE_1__);

// import { McpServer } from '@modelcontextprotocol/sdk/server/mcp.js'
// import { StdioServerTransport } from '@modelcontextprotocol/sdk/server/stdio.js'

const instance = new _mockClass__WEBPACK_IMPORTED_MODULE_0__["MockClass"]();
...
/***/ "./background/mockClass.js":
/*!*********************************!*\
  !*** ./background/mockClass.js ***!
  \*********************************/
/*! exports provided: MockClass */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MockClass", function() { return MockClass; });
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils */ "./background/utils.js");
...
class MockClass {
  ...
  createMockData(mockDescribeJson) {
    const form = Object(_utils__WEBPACK_IMPORTED_MODULE_2__["createFormByDeepMapData"])(mockDescribeJson);
    const foreignKeyList = [];
    const syntaxRes = Object(_utils__WEBPACK_IMPORTED_MODULE_2__["getMockjsSyntax"])(form, foreignKeyList);
    const mockRes = mockjs__WEBPACK_IMPORTED_MODULE_1___default.a.mock(syntaxRes);
...
/*!*****************************!*\
  !*** ./background/utils.js ***!
  \*****************************/
/*! exports provided: createFormByDeepMapData, defineDatabaseType, getMockjsSyntax, createForeignKeyList, fillForeignKeyList, createFormColumns, formatMockData, deepTraverse */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createFormByDeepMapData", function() { return createFormByDeepMapData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "defineDatabaseType", function() { return defineDatabaseType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMockjsSyntax", function() { return getMockjsSyntax; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createForeignKeyList", function() { return createForeignKeyList; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fillForeignKeyList", function() { return fillForeignKeyList; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createFormColumns", function() { return createFormColumns; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatMockData", function() { return formatMockData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "deepTraverse", function() { return deepTraverse; });
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./const */ "./background/const.js");
/* harmony import */ var _extend_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./extend/index */ "./background/extend/index.js");
...
function createFormByDeepMapData(data, prop) {
  let tmp = null;
  if (data.type === 'object') {
    tmp = {};
...
const list = {
  ...
  boolean(row, key) {
    const tmpObj = list.default(row, key);
    tmpObj.mValue = '@boolean' ? 1 : undefined;
    return tmpObj;
  },
  array(row, key) {
    const tmpObj = list.default(row, key);
...
function formatVal(row, key) {
  ...
  return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["merge"])(row, fn(row, key));
}
function splitWords(str) {
  if (!str) return [];
  return str.split(/(?=[A-Z])/).map(lodash__WEBPACK_IMPORTED_MODULE_2__["toLower"]);
}
function includesWords(str, words) {
  if (!Object(lodash__WEBPACK_IMPORTED_MODULE_2__["isArray"])(words)) words = [words];
...
function defineDatabaseType(obj, value, prop = '__databaseType__') {
...
function getMockjsSyntax(data, keyList, parentPath = '') {
...
function createForeignKeyList(data, parentPath = '') {
  const tmpArr = [];
  if (data.__databaseType__ === 'object' || data.__databaseType__ === 'array' && data.notObjectArray) {
    const keys = Object.keys(data);
    for (let key of keys) {
...
function fillForeignKeyList(data, keyList) {
  keyList.map(({
    from,
    to
  }) => {
...
const foreignKeyList = [];
function createFormColumns(data, prop) {
  let option = null;
  if (!prop) {
  ...
  if (data.__databaseType__ === 'object' || data.__databaseType__ === 'array') {
    ...
    if (data.__databaseType__ === 'string') {
      ...
      option.dicData = _const__WEBPACK_IMPORTED_MODULE_0__["dicOfString"];
    }
...
function formatMockData(data) {
  ...
  function uniqPrimitiveArray(value) {
    ...
    const uniqVal = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["uniq"])(value);
    value.length = 0;
    value.push(...uniqVal);
  }
  function isPrimitiveArray(value) {
    if (!Object(lodash__WEBPACK_IMPORTED_MODULE_2__["isArray"])(value)) return false;
    return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["every"])(value, isPrimitive);
  }
}
function deepTraverse(value, callback) {
  if (Object(lodash__WEBPACK_IMPORTED_MODULE_2__["isArray"])(value)) {
    // 遍历数组中的每个元素
    Object(lodash__WEBPACK_IMPORTED_MODULE_2__["forEach"])(value, (item, index) => {
      callback(item, index, value); // 调用回调函数
      deepTraverse(item, callback); // 递归遍历子项
    });
  } else if (Object(lodash__WEBPACK_IMPORTED_MODULE_2__["isObject"])(value)) {
    // 遍历对象中的每个键值对
    Object(lodash__WEBPACK_IMPORTED_MODULE_2__["forEach"])(value, (item, key) => {
...
function flatMapDeepByArray(data, mapArr = [], mapKeyArr = []) {
  ...
  if (Object(lodash__WEBPACK_IMPORTED_MODULE_2__["isPlainObject"])(data)) {
  ...
  for (let i = 0; i < mapArr.length; i++) {
    flatMapArr = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["flatMapDeep"])(flatMapArr, n => {
      const arr = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["get"])(n, `${[mapArr[i]]}`, []);
